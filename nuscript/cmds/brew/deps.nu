...
# show dependencies for formula/e. When given multiple formulae, show the intersection of dependencies for each formula. If no formula/e is given, show dependencies for all installed formula/e
# Usage: brew deps [formula]
# Options:
...
# Usage: brew deps missing [formula]
# options:
#   formula: Formula/e to check for missing dependencies
export def missing [formula: string] {
  ^brew deps $formula --missing | lines | parse "{name}: {dependencies}"
}

# Show dependencies for formula/e. When given multiple formulae, show the intersection of dependencies for each formula. If not formula/e is given, show dependencies for all installed formulae.
