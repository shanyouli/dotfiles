...
local function isTrackDisabled(index, type)
	return (type == "sub2" and isTrackSelected(index, "sub")) or (type == "sub" and isTrackSelected(index, "sub2"))
end
...
local function get_track_title(track, type, filename)
	...
	if track.lang then
		title = string.format("%s, %s", title, track.lang)
	end
	if #hints > 0 then
...
add_keys(o.key_scroll_down, "scroll_down", function()
	list:scroll_down()
end, { repeatable = true })
add_keys(o.key_scroll_up, "scroll_up", function()
	list:scroll_up()
end, { repeatable = true })
add_keys(o.key_move_pageup, "move_pageup", function()
	list:move_pageup()
end, {})
add_keys(o.key_move_pagedown, "move_pagedown", function()
	list:move_pagedown()
end, {})
add_keys(o.key_move_begin, "move_begin", function()
	list:move_begin()
end, {})
add_keys(o.key_move_end, "move_end", function()
	list:move_end()
end, {})
