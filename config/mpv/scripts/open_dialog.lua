...
local function import_files(type)
	...
	elseif type == "sid" then
		...
		filter = string.format(
			"All Files (*.*)|*.*|Video Files|%s|Audio Files|%s|Image Files|%s|ISO Files|%s|Subtitle Files|%s|Playlist Files|%s",
			file_types["video"],
			file_types["audio"],
			file_types["image"],
			file_types["iso"],
