-- @see https://github.com/nekowinston/dotfiles/blob/main/dot_config/wezterm/wezterm.lua}}}
...
local font = get_font("maple")
local act = wezterm.action

return {
	-- keyboard shortcuts {{{
	disable_default_key_bindings = false,
	leader = { key = "c", mods = "CTRL", timeout_milliseconds = 5000 },
	keys = {
