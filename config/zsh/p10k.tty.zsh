# Generated by Powerlevel10k configuration wizard on 2020-12-14 at 22:54 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh.
# Wizard options: ascii, lean_8colors, 24h time, 2 lines, solid, blue-ornaments,
# compact, fluent, transient_prompt, instant_prompt=off.
